                    ...
                    for k in range(10):
                        ...
                        if pre_ind != -1 and next_ind != -1:
                            ...
                            if np.random.uniform() <= rotate_prob:
                                ...
                                next_ind_list.append(next_sim)
                                radials_list.append(new_radial)
                            folder_path = patch_folder+'offset/point_' + str(max_points) + '_gp_' + str(gap_size)+'/'+'d'+str(i)
                            if not os.path.exists(folder_path):
                                os.makedirs(folder_path)
                            record_name = 'offset/point_' + str(max_points) + '_gp_' + str(gap_size)+'/'+'d'+str(i)+'/' + 'd_' + str(i) + '_' + 'v_' + str(v) + '_' + 'patch_%d_' % counter+str(k)+'.nii.gz'
                            org_name = patch_folder + record_name
...
def create_patch_images(max_points,path_name,spacing_path,gap_size):
    ...
    for i in range(0,1):
        ...
        csv_name = "D:/LiChen/RotterdanCoronary/patch/offset/" + 'point_' + str(max_points) + '_gp_' + str(
...
max_points = 500
gap_size = 1
path_name = r'D:\LiChen\RotterdanCoronary\training//dataset'
patch_folder = 'D:/LiChen/RotterdanCoronary/patch/'
