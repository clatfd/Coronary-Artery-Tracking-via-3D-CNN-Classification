                    ...
                    for k in range(5):
                        ...
                        if pre_ind != -1 and next_ind != -1:
                            ...
                            if np.random.uniform() <= rotate_prob:
                                ...
                                next_ind_list.append(next_sim)
                                radials_list.append(new_radial)
                            folder_path = r'D:\LiChen\BRAVEpatch/icafe_patch/offset/point_' + str(max_points) + '_gp_' + str(gap_size)+'/'+'d'+pi
                            if not os.path.exists(folder_path):
                                os.makedirs(folder_path)
                            record_name = 'icafe_patch/offset/point_' + str(max_points) + '_gp_' + str(gap_size)+'/'+'d'+pi+'/' + 'd_' + pi + '_' + 'v_' + str(v) + '_' + 'patch_%d_' % counter+str(k)+'.nii.gz'
                            org_name = r'D:\LiChen\BRAVEpatch/' + record_name
...
def create_patch_images(max_points,path_name,spacing_path,gap_size):
    ...
    for i in range(50,80):
        ...
        csv_name = r"D:\LiChen\BRAVEpatch/icafe_patch/offset/" + 'point_' + str(max_points) + '_gp_' + str(
...
max_points = 500
gap_size = 1
path_name = r'\\DESKTOP2\iCafe\result\BRAVE'
