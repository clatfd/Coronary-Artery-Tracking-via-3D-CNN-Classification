...
from dcat_data_provider import DCATDataGenerater
...
def get_dataset(train_patch_list,val_patch_list):
    ...
    train_dataset = DCATDataGenerater(train_patch_list, train_pre_fix_path, 500, train_transforms, train_flag, target_transform)

    val_pre_fix_path = r"D:\LiChen\BRAVEpatch"
    val_flag = 'val'
    test_valid_transforms = None
    target_transform = None
    val_dataset = DCATDataGenerater(val_patch_list, val_pre_fix_path, 500, test_valid_transforms, val_flag, target_transform)
